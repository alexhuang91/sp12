...
then
echo "paths_to_update didn't match at iteration break number 2"
pass=false
fi
...
then
echo "compare_paths didn't match at iteration break number 2"
pass=false
fi
...
then
echo "new_paths didn't match at iteration break number 2"
pass=false
fi
...
then
echo "paths didn't match at iteration break number 2"
pass=false
fi

if ! $pass ; then
echo "wrong output at iteration break number 2; stopping"
exit
fi
...
then
echo "paths_to_update didn't match at iteration break number 3"
pass=false
fi
...
then
echo "compare_paths didn't match at iteration break number 3"
pass=false
fi
...
then
echo "new_paths didn't match at iteration break number 3"
pass=false
fi
...
then
echo "paths didn't match at iteration break number 3"
pass=false
fi

if ! $pass ; then
echo "wrong output at iteration break number 3; stopping"
exit
fi
...
echo "Intermediate tables and output matched for test-sm.csv! Nice job."
