...
/* ----------------
 *	 SimJoinState
 *             lol, like we'd provide comments for this. WHAT ARE WE, NICE?
 *             hidden kitty picture: http://i.imgur.com/rBdZV.jpg
 * ----------------
 */
typedef struct SimJoinState {
  /* CS186 SimJoin stuff -- the no touch section */
  JoinState	    js;
  ...
  /* CS186: ADD YOUR OWN SIMJOIN STATE VARIABLES HERE */
...
typedef struct NestLoopState
{
	...
	TupleTableSlot *nl_NullInnerTupleSlot;
        SimJoinState   *hacky_simJoinState; /* CS186 */
} NestLoopState;
